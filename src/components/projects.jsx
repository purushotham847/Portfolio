...
<Comp img={'homepage.png'}  title={'Hostile Detection'} des={"An ML application that uses computer vision techniques to detect hostile or dangerous behaviors such as fire, fights, and weapons in real-time surveillance footage."} demo={"https://github.com/purushotham847/Hostile-detection-system?tab=readme-ov-file#readme"}  code={"https://github.com/purushotham847/Hostile-detection-system" }/>
<Comp img={'tms.png'}  title={'Translation Management'} des={"This project is a Django-based web application designed to manage translation and review workflows efficiently. It supports user registration, authentication, job allocation, and detailed ........."} demo={ "https://github.com/purushotham847/Translation-Management-System?tab=readme-ov-file#readme"}  code={"https://github.com/purushotham847/Translation-Management-System" }/>
